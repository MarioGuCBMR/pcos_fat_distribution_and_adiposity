...
pcos=fread("raw_data/summary_stats_release_finngen_R12_E4_PCOS_BROAD.gz")
...
pcos_no_mhc$sample_cases=4810
pcos_no_mhc$sample_controls=273021
pcos_no_mhc$sample_size=4810+273021
pcos_no_mhc$prevalence=0.84 #Unadjusted period prevalence% in whole population from: https://risteys.finngen.fi/endpoints/E4_PCOS_BROAD

#We are done!

fwrite(pcos_no_mhc, "output/1_curated_data/pcos_finngen_broad_curated.txt")
