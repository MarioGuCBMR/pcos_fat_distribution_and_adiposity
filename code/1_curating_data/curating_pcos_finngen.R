...
pcos=fread("raw_data/summary_stats_release_finngen_R12_E4_PCOS.gz")
...
lifted_unlisted = unlisted(lifted)
...
pcos_no_mhc$sample_cases=2214
pcos_no_mhc$sample_controls=267780
pcos_no_mhc$sample_size=2214+267780
pcos_no_mhc$prevalence=0.38 #Unadjusted period prevalence% in whole population from: https://risteys.finngen.fi/endpoints/E4_PCOS

#We are done!

fwrite(pcos_no_mhc, "output/1_curated_data/pcos_finngen_curated.txt")
